...
{
    auto stype = ast::checkedCast<type::Set>(s->type());
...
void CodeBuilder::visit(expression::operator_::set::Timeout* i)
{
    auto op1 = cg()->hiltiExpression(i->op1());
    ...
    cg()->builder()->addInstruction(nullptr, hilti::instruction::set::Timeout, op1, strategy, time_interval);
